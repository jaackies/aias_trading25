...
# best, score= whale_optimization(fitness_func=bot_fitness_func, bot_type="complex", dim=14, bounds=[(1, 10), (1, 10), (1, 10), # w1, w2, w3 
#                                                                                                    (2, 50), (2, 50), (2, 50), # d1, d2, d3 
#                                                                                                    (0, 1), # sf # -- Low part --
#                                                                                                    (1, 10), (1, 10), (1, 10),
#                                                                                                    (2, 90), (2, 90), (2, 90),
#                                                                                                    (0, 1)], num_agents= 10, max_iter= 10, integer_dims= [3,4,5,10,11,12])
# low: 11 - 40， 
# high: 1-10
