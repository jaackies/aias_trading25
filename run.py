...
# best, score= whale_optimization(fitness_func=bot_fitness_func, bot_type="sma", dim=2, bounds=[(1,10), (11,40)], num_agents= 10, max_iter= 100, integer_dims= [0,1])
best, score= whale_optimization(fitness_func=bot_fitness_func, bot_type="complex", dim=14, bounds=[(1, 10), (1, 10), (1, 10), (2, 50), (2, 50), (2, 50), (0, 1), (1, 10), (1, 10), (1, 10),(2, 90), (2, 90), (2, 90),(0, 1)], num_agents= 10, max_iter= 10, integer_dims= [3,4,5,10,11,12])
# low: (11, 40)， (51,100)
# high: (1, 10), (5, 50)
