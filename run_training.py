...
# Group A - SMA:
# best, score = particle_swarm_optimization(
#     fitness_func=bot_training, 
#     bot_type="sma", 
#     dim=2, 
#     bounds=[(1,10), (11,40)], 
#     num_agents=10, 
...
#     bot_type="complex", 
#     dim=14, 
#     bounds=[(0, 10), (0, 10), (0, 10), (1, 10), (1, 10), (1, 10), (0, 1), 
#             (0, 10), (0, 10), (0, 10), (11, 40), (11, 40), (11, 40), (0, 1)], 
#     num_agents=10, 
#     max_iter=100, 
...
#     bot_type="sma", 
#     dim=2, 
#     bounds=[(5,50), (51,100)],  # Group B bounds
#     num_agents=10, 
#     max_iter=100, 
#     integer_dims=[0,1],
#     group="B"
...
#     bot_type="smaema", 
#     dim=3, 
#     bounds=[(5,50), (51,100), (0,1)],  # Group B bounds
#     num_agents=10, 
#     max_iter=100, 
#     integer_dims=[0,1],
#     group="B"
...
best, score = particle_swarm_optimization(
    ...
    bot_type="complex", 
    dim=14, 
    bounds=[(0, 10), (0, 10), (0, 10), (5, 50), (5, 50), (5, 50), (0, 1), 
            (0, 10), (0, 10), (0, 10), (51, 100), (51, 100), (51, 100), (0, 1)], 
    num_agents=10, 
    max_iter=100, 
    integer_dims=[3,4,5,10,11,12],
    group="B"
